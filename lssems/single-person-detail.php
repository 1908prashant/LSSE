...
<div class="listing-contact-table-field">
										...
										<div class="listing-contact-table-field">
											<ul>
												<li class="info" style="font-weight:bold">Most Choice</li>
												<li class="details"><?php  echo $row->Choice;?></li>
											</ul>
										</div>
										<div class="listing-contact-table-field">
											<ul>
												<h5>Ms. Kailash Kher has been a dedicated teacher for over 20 years, with extensive experience teaching a variety of subjects to students of all ages. She began her teaching career after earning a Bachelor's degree in Education from XYZ University, and went on to earn a Master's degree in Curriculum and Instruction from ABC University.
</h5>
											</ul>
										</div>
