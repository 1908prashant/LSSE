...
$sql="insert into tblperson(Category,Name,Picture,MobileNumber,Address,City,choice)values(:cat,:name,:pics,:mobilenumber,:address,:city,:choice)";
...
<option value="<?php echo htmlentities($row->Category);?>"><?php echo htmlentities($row->Category);?></option>
 <?php } ?> 
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">selected_by</label>
                    <input type="text" class="form-control" id="choice" name="" placeholder="choice" required="true">
                  </div>  
